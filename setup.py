...
path_to_main_file = os.path.join(dir, "src/beancount_extensions/future_transactions/__init__.py")
...
for line in open(path_to_main_file):
	...
	raise ValueError('"__version__" not found in "src/beancount_extensions/future_transactions/__init__.py"')
...
setup(
	...
	package_dir=dict([
					("beancount_extensions.future_transactions", "src/beancount_extensions/future_transactions"),
					]),
